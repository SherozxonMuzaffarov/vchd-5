...
router.post('/create', authMiddleware, validations.vagon, vagonController.create)
router.delete('/delete/:id', authMiddleware, vagonController.delete)
router.patch('/update/:id', authMiddleware, validations.vagon, vagonController.update)
