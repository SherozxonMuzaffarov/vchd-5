        ...
        <div class="mt-5">
            <div class="card shadow-sm" style="overflow: auto; white-space: nowrap">
                ...
                <BTableSimple striped="true" hover="true" bordered="true" class="mt-4">
                    <BThead >
                        <BTr >
                            <BTh colspan="11" >Прихот</BTh>
                            <BTh rowspan="4">Расхот</BTh>
                        </BTr>
                        <BTr >
                            <BTh rowspan="3" class="vertical-text " >№ По порядку</BTh>
                            <BTh rowspan="3" class="vertical-text" >Дата поступления</BTh>
                            <BTh rowspan="3" >
                            ...
                            <BTh colspan="8">Характеристика колосной пары</BTh>
                        </BTr>
                        <BTr >
                            <BTh rowspan="2" class="vertical-text">Тип колосной пары</BTh>
                            <BTh rowspan="2">Номер <br/> колосной  пары</BTh>
                            <BTh rowspan="2" class="vertical-text">Дефект</BTh>
                            <BTh colspan="3">Дата и пункт</BTh>
                            <BTh colspan="2" rowspan="3" class="vertical-text">
                                Диаметр по кругу <br/> катания колеса <br/>
                                ( числитель-правос, <br/> знаменатель-левос)
                            </BTh>
                        </BTr>
                        <BTr class="align-middle">
                            <BTh class="vertical-text">Изготовления оси</BTh>
                            <BTh class="vertical-text">Последного <br/> формирования</BTh>
                            <BTh class="vertical-text">
